    ...
    return (
        <>
            <div className="filtrosContainer">
                <div className="filtrosContainerElementos">
                    <div className="-barra">
                    ...
                    <div className="-filtraje">
                        <Botones className='-btnF' icon='options-outline' onClick={() => setAbierto(!abierto)}></Botones>
                    </div>
                </div>
                ...
                {abierto && (
                    <div className="dropdownContainer">
                        {categorias.map((cat, i) => (
                            <div className="dropdowContainerCat">
                                < label key={i} >
                                <input
                                    type="checkbox"
